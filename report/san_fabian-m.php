    ...
    <div class="col-md-12">
        <div class="card" style="width: 115%; margin-left: -75px;">
            ...
            <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM students WHERE (brgy = 'san fabian' AND status = 'scholars' AND gender= 'male') ORDER BY scholar_id ASC";
        ...
        <?php
$count_query = "SELECT * FROM students WHERE status= 'scholars' AND brgy='san fabian' AND gender= 'male'";
