    ...
    <div class="col-md-12">
        <div class="card" style="width: 115%; margin-left: -75px;">
            <div class="card-header" style="background-color:lightblue;">
                <center><h2>Pulong Buli</h2></center>
            </div>
            <div class="card-body">
            ...
            <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM students WHERE (brgy = 'pulong buli' AND status = 'scholars' AND gender = 'female' ) ORDER BY scholar_id ASC";
        ...
        <?php
$count_query = "SELECT * FROM students WHERE status= 'scholars' AND brgy='pulong buli' AND gender = 'female' ";
