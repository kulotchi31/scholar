  ...
  <section class="center-text">
    ...
    <div class="login-form box-center">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        ...
        <select name="forma" onchange="">
    <option value="Home"><a href="home.php">location = Home</a></option>
    <option value="Contact"><a href="homescho">Contact</a></option>
    <option value="Sitemap"><a href="profile.php">Sitemap</a></option>
</select>
