...
<li><a class="dropdown-item" href="casulucan-f.php">Female</a></li>
            ...
            <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT students.*,course_tbl.*,university_tbl.* FROM students join course_tbl on fk_course_id=Course_ID join university_tbl on fk_university_id=university_id WHERE (brgy = 'casulucan' AND status = 'scholars') ORDER BY id ASC";
