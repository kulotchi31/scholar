...
<h2 style="float: left;">Malayantoc</h2>
            ...
            <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT students.*,course_tbl.*,university_tbl.* FROM students join course_tbl on fk_course_id=Course_ID join university_tbl on fk_university_id=university_id WHERE (gender = 'male' AND status = 'scholars' AND brgy = 'malayantoc') ORDER BY id ASC";
