            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#disability">Add Requirements</button>
                        <br><br>
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM requirements_tbl WHERE fk_scholar_id = '$scholar' ORDER BY requirements_id ASC";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="course.php" method="POST">
                                                    <a href="editrequirements.php?id=<?= $requirements['requirements_id']; ?>" class="btn btn-info btn-sm comfirm-delete">View</a>
